...
class Mailer
{
    ...
    function send($recipients, $subject, $body, $options = null)
    {
        ...
        if (
            $body instanceof \TextWithExtras
    ...
    function sendSig($recipients, $subject, $body=null)
    {
        $subject = preg_replace("/(\r\n|\r|\n)/s", '', trim($subject));
        $formName =  $this->getFromName();
        $FromAddress = $this->getFromEmail();
        $headers = [
            "From" => "$formName <$FromAddress>",
        ...
        foreach ($recipients as $recipient) {
            ...
            $msg = "
                ...
                '>
                    <div class='content'>
                        <header>
                            <div class='h-sub flex'>
                                <div class='con'>
                                    <div class='logo'><img src='/osticket_8.2_dev-master/scp/images/ozTicket-banner-logo.png' alt='' width='300' height='52'></div>
                                </div>
                                <div class='con'>
                                    <span class='bold-b'>Job Ticket</span>
                                    <span class='ticket-id'>#4541516</span>
                                </div>
                            </div>
                        </header>
                        <div class='t-section'>
                        ...
                        <section>
                            <div class='info'>
                                ...
                                <span class='value'>INT982005</span>
                                <br>
                                <span class='title'>Tranding Name</span>
                                <span class='value'>Lorem Ipsum is simply dummy text of the printing and typesetting industry</span>
                                <br>
                                <span class='title'>First Name</span>
                                <span class='value'>Mohammed</span>
                                <span class='title'>Mobile</span>
                                <span class='value'>+2250544540144</span>
                                <br>
                                <span class='title'>Last Name</span>
                                <span class='value'>Michel</span>
                                <span class='title'>Phone Number</span>
                                <span class='value'>+5621541144</span>
                                <br>
                                <span class='title'>Email address 1</span>
                                <span class='value'>aabbb@trummb.usa</span>
                                <br>
                                <span class='title'>Email address 2</span>
                                <span class='value'>pedri.mob@fotball.net</span>
                        ...
                        <section>
                            <div class='info'>
                                ...
                                <span class='value'>nw york</span>
                                <span class='sub-title'>Postcode</span>
