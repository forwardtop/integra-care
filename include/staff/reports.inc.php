            ...
            <tr id="<?php echo $row['ticket_id']; ?>">
                <td title="<?php echo $row['email']; ?>" nowrap> 
                  <a class="Icon <?php echo strtolower($row['source']); ?>Ticket ticketPreview" title="Preview Ticket" 
                    href="tickets.php?id=<?php echo $row['ticket_id']; ?>" style="color:#f45511;"><?php echo $tid; ?></a>
                </td>
                ...
                <td nowrap width="5" bgcolor="#ffffff" style='text-align: center'> <?php echo $row['age']; ?> </td>
            </tr>
            <?php
            } //end of while.
