...
<tr>
 ...
 <table class="form_table" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr>
            <td width="160" style='border-bottom: 2px solid #0094B3'>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: 
            </td>
            <td style='border-bottom: 2px solid #0094B3'>
        ...
        <tr>
            ...
            <td>
                <input type="text" size="40" name="other_dept5" id="other_dept5" value="<?php echo $info['other_dept5']; ?>">
            </td>
        </tr>
        <tr>
            <td width="160">
            ...
            <td>
                <input type="text" size="50" name="other_contact5" id="other_contact5" value="<?php echo $info['other_contact5']; ?>">
            </td>
        </tr>
        <tr>
            <td width="160">
            ...
            <td>
                <input type="text" size="18" name="other_phone5" id="other_phone5" class="typeahead" value="<?php echo $info['other_phone5']; ?>"
                    autocomplete="off" autocorrect="off" autocapitalize="off"> &nbsp;
                    Mobile:
                <input type="text" size="18" name="other_mobile5" id="other_mobile5" class="typeahead" value="<?php echo $info['other_mobile5']; ?>"
                    autocomplete="off" autocorrect="off" autocapitalize="off">
            </td>
        </tr>
        <tr>
            ...
            <td style='border-bottom: 2px solid #0094B3'>
                <input type="text" size="50" name="other_email5" id="other_email5" value="<?php echo $info['other_email5']; ?>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" size="40" name="other_dept6" id="other_dept6" value="<?php echo $info['other_dept6']; ?>">
            </td>
        </tr>
        <tr>
            <td width="160">
            ...
            <td>
                <input type="text" size="50" name="other_contact6" id="other_contact6" value="<?php echo $info['other_contact6']; ?>">
            </td>
        </tr>
        <tr>
            <td width="160">
            ...
            <td>
                <input type="text" size="18" name="other_phone6" id="other_phone6" class="typeahead" value="<?php echo $info['other_phone6']; ?>"
                    autocomplete="off" autocorrect="off" autocapitalize="off"> &nbsp;
                    Mobile:
                <input type="text" size="18" name="other_mobile6" id="other_mobile6" class="typeahead" value="<?php echo $info['other_mobile6']; ?>"
                    autocomplete="off" autocorrect="off" autocapitalize="off">
            </td>
        </tr>
        <tr>
            ...
            <td style='border-bottom: 2px solid #0094B3'>
                <input type="text" size="50" name="other_email6" id="other_email6" value="<?php echo $info['other_email6']; ?>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" size="40" name="other_dept7" id="other_dept7" value="<?php echo $info['other_dept7']; ?>">
            </td>
        </tr>
        <tr>
            <td width="160">
            ...
            <td>
                <input type="text" size="50" name="other_contact7" id="other_contact7" value="<?php echo $info['other_contact7']; ?>">
            </td>
        </tr>
        <tr>
            <td width="160">
            ...
            <td>
                <input type="text" size="18" name="other_phone7" id="other_phone7" class="typeahead" value="<?php echo $info['other_phone7']; ?>"
                    autocomplete="off" autocorrect="off" autocapitalize="off"> &nbsp;
                    Mobile:
                <input type="text" size="18" name="other_mobile7" id="other_mobile7" class="typeahead" value="<?php echo $info['other_mobile7']; ?>"
                    autocomplete="off" autocorrect="off" autocapitalize="off">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" size="50" name="other_email7" id="other_email7" value="<?php echo $info['other_email7']; ?>">
            </td>
        </tr>
    </tbody>
</table>
