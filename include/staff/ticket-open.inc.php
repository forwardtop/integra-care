  ...
  <table class="form_table fixed" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <input type="text" size="20" name="direct_phone" id="direct_phone" value="<?php echo $info['direct_phone']; ?>">
          &nbsp;<span class="error">&nbsp;<?php echo $errors['direct_phone']; ?></span>
    ...
    <tbody>
      ...
      <?php } ?>
        ...
        var start = Math.max(rows.length - 1, 0);
