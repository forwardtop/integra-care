  ...
  <div class="sticky bar">
    <div class="content">
      <div class="pull-right flush-right">
        ...
        <div id="action-dropdown-print" class="action-dropdown anchor-right">
          <ul>
            ...
            <li title="ZIP Archive"><a class="no-pjax" target="_blank" href="tickets.php?id=<?php echo $ticket->getId(); ?>&a=zip&notes=1&tasks=1"><i class="icon-folder-close-alt"></i>
            ...
            <ul>
              ...
              if (
                ...
                <li><a class="no-pjax ticket-action" data-redirect="tickets.php?id=<?php echo
                                                                                    $ticket->getId(); ?>" href="#tickets/<?php echo $ticket->getId(); ?>/claim"><i class="icon-chevron-sign-down"></i>
                    <?php echo __('Claim'); ?></a>
                <?php
              } ?>
                <li><a class="no-pjax ticket-action" data-redirect="tickets.php" href="#tickets/<?php echo $ticket->getId(); ?>/assign/agents"><i class="icon-user"></i>
                    <?php echo __('Agent'); ?></a>
                <li><a class="no-pjax ticket-action" data-redirect="tickets.php" href="#tickets/<?php echo $ticket->getId(); ?>/assign/teams"><i class="icon-group"></i>
                    <?php echo __('Team'); ?></a>
            </ul>
          </div>
        <?php
          ...
          <ul>
            ...
            if ($role->hasPerm(Ticket::PERM_DELETE)) {
              ...
              <li class="danger"><a class="ticket-action" href="#tickets/<?php
                                                                          echo $ticket->getId(); ?>/status/delete" data-redirect="tickets.php"><i class="icon-trash"></i>
                  <?php
      ...
      <div class="flush-left" style="display: inline-block;">
        <h2 style="display: inline-block;"><a href="tickets.php?id=<?php echo $ticket->getId(); ?>" title="<?php echo __('Reload'); ?>"><i class="icon-refresh"></i>
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0" style="margin-top:12px;">
  <tr>
    <td width="50%" style="vertical-align:top">
      <table border="0" cellspacing="0" cellpadding="4" width="100%">
        <tr style="background: #0094b3; color:white">
          <th width="30%"></th>
          <th>
            <b style="color:white"><?php echo __('Customer Details'); ?></b>
          </th>
        </tr>
        <tr>
          <th>
          ...
          <td><?php echo $ticket->getExtraData('company'); ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php
              echo $ticket->getExtraData('email2');
        ...
        <tr>
          ...
          <td><?php echo $ticket->getExtraData('mobile'); ?></td>
        </tr>
        <tr>
          <th>
            <?php echo __('Address'); ?>:
          ...
          <td><?php
              echo $ticket->getExtraData('address');
              ?>
          </td>
        </tr>
        <tr>
          ...
          <td><?php
              echo  $ticket->getExtraData('address2');
              ?>
          </td>
        </tr>
        <tr>
          ...
          <td><?php echo $ticket->getExtraData('suburb'); ?></td>
        </tr>
        ...
        <tr>
          ...
          <td><?php echo $ticket->getExtraData('state'); ?></td>
        </tr>
        <tr>
          <th>
          ...
          <td><?php
              echo $ticket->getExtraData('postcode');
        ...
        <tr>
          <th color='#0A568E'><?php echo __('Source'); ?>:</th>
          <td><?php
    ...
    <td width="50%" style="vertical-align:top">
      <table border="0" cellspacing="0" cellpadding="4" width="100%">
        <tr style="background: #0094b3; color:white">
          <th width="30%"></th>
          <th>
            <b style="color:white">Ticket Details</b>
          </th>
        </tr>
        <tr>
          <th>
        ...
        <tr>
          ...
          <td><?php
              $cn = $ticket->getExtraData('contract');
              if ($cn) {
                echo $cn;
              } else {
                echo "N/A";
    ...
    <td width="50%" style="vertical-align:top">
      <table cellspacing="0" cellpadding="4" width="100%" border="0">
        <tr style="background: #0094b3; color:white">
          <th width="30%"></th>
          <th>
            <b style="color:white">Upstream Details
          </th>
        </tr>
        <tr>
          <th>
        ...
        <tr>
          ...
          <td><?php echo $ticket->getExtraData('carrier'); ?></td>
        <tr>
          <th>
            <?php echo __('Carrier Ref'); ?>:
          </th>
          <td><?php echo $ticket->getExtraData('carrier_ref'); ?></td>
        </tr>
      </table>
    </td>
    <td width="50%">
      <table cellspacing="0" cellpadding="4" width="100%" border="0">
        <tr style="background: #0094b3; color:white">
          <th width="30%"></th>
          <th>
            <b style="color:white;">Ticket Response</b>
          </th>
        </tr>
        <?php
        if ($ticket->isOpen()) { ?>
  ...
  <div id="ticket_thread" class="tab_content">
    ...
    <div class="sticky bar stop actions" id="response_options">
      <ul class="tabs" id="response-tabs">
        ...
        <li><a id="signature_tab" href="#signature"><?php echo $ticket->isAssigned() ? __('Signature Ticket') : __('Signature Ticket'); ?></a>
        </li>
      </ul>
      <?php
      if ($role->hasPerm(Ticket::PERM_REPLY) && !($blockReply)) {
                ...
                <tr id="user-row">
                  ...
                  <td>
                    ...
                    <div id="ccs" class="hidden">
                      <div>
                        <span style="margin: .625rem .3125rem .0625rem 0;" class="faded pull-left"><?php echo __('Select or Add New Collaborators'); ?>&nbsp;</span>
                        <?php
                        if ($role->hasPerm(Ticket::PERM_REPLY) && $thread && $ticket->getId() == $thread->getObjectId()) { ?>
                          <span class="action-button pull-left" style="margin: .125rem  0 .3125rem 1.25rem;" data-dropdown="#action-dropdown-collaborators" data-placement="bottom" data-toggle="tooltip" title="<?php echo __('Manage Collaborators'); ?>">
                            <i class="icon-caret-down pull-right"></i>
              ...
              <tr>
                ...
                <td>
                  ...
                  if ($thisstaff->getSignature()) { ?>
                    <label><input type="radio" name="signature" value="mine" <?php echo ($info['signature'] == 'mine') ? 'checked="checked"' : ''; ?>>
      ...
      <form id="signature" action="tickets.php?id=<?php echo $ticket->getId(); ?>#signature" name="signature" method="POST">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            ...
            <div style="margin-left:10px;">
              I, <input type="signature_name" id="signature_name" name="signature_name" required style="height:1.5625rem;width:20%;background-color:#f9f9f9;" /> hereby confirm that lntegra engineer/representative has attended the site location as per the address details outlined above in this ticket. The lntegra engineer/representative has successfully completed the work and/or resolved the
              fault, <p>and/or delivered the goods and/or services specified in this ticket.
                We acknowledge that the work and/or delivery has been executed</p>
              <p>to our satisfaction. Furthermore, we agree to fulfill the financial obligations by paying for the products delivered ad the associated fees </p>
              <p>ad charges mentioned in this ticket.</p>
            </div>
            <div class=" grid-container">
              ...
              <div class=" item3"><strong>Integra Engineer or Representative Name:</strong></div>
              <div class="item4"><select name="assignId" id="assignId">
                  <?php
                  if (
                    $ticket->isOpen()
                    && !$ticket->isAssigned()
              ...
              <div class="item6"><input type="datetime-local" id="signature_date" name="signature_date" required style="height: 1.5625rem; background-color: #f9f9f9" step="0" />
                <span id="calendar_icon" style="cursor:pointer;margin-left:12px;">📅</span>

              </div>
              <div class=" item7" style="padding: 1.25rem;font-size:.875rem">
              </div>
            </div>
    ...
    <script>
      document.getElementById('calendar_icon').addEventListener('click', function() {
        // Get the current date and time in UTC+10 timezone
        var now = new Date();
        var utc10Offset = 10 * 60 * 60 * 1000; // UTC+10 offset in milliseconds
        var utc10Time = new Date(now.getTime() + utc10Offset);

        // Format the date and time to a string compatible with the datetime-local input
        var formattedDate = utc10Time.getUTCFullYear() + '-' +
          ('0' + (utc10Time.getUTCMonth() + 1)).slice(-2) + '-' +
          ('0' + utc10Time.getUTCDate()).slice(-2);
        var formattedTime = ('0' + utc10Time.getUTCHours()).slice(-2) + ':' +
          ('0' + utc10Time.getUTCMinutes()).slice(-2);

        var dateTimeValue = formattedDate + 'T' + formattedTime;

        // Set the value of the input field to the current date and time in UTC+10 timezone
        document.getElementById('signature_date').value = dateTimeValue;
      });
    </script>