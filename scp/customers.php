...
//            " 	service2_type7	 = '" . db_input($vars['service2_type7'], false) . "',  " .
        ...
        // first delete all Mobile
        $mobile_del_sql = "delete from " . TABLE_PREFIX . "customer_mobilehwd where customer_id= '" . $_REQUEST['id'] . "' ";
        db_query($mobile_del_sql);

        if($vars['mobilehwd'])
            // insert Mobile
            for ($i = 0; $i < count($vars['mobilehwd']['mobile_provider']); $i++) {
                $mobile_open_sql = "INSERT into " . TABLE_PREFIX . "customer_mobilehwd " .
                    " (mobile_service_number,mobile_device_type,mobile_network,mobile_provider,mobile_service_id_ref,mobile_plan," .
                    "mobile_data_allowance,mobile_cost,mobile_user_description,mobile_contract_type,mobile_service_type,mobile_share_data," .
                    "mobile_comments,mobile_date_order,mobile_date_activation,mobile_date_cancel,mobile_order_ref,mobile_activation_ref,mobile_cancel_ref,customer_id,last_update) " .
                    " VALUES " .
                    " ('" . $vars['mobilehwd']['mobile_service_number'][$i] . "','" . $vars['mobilehwd']['mobile_device_type'][$i] . "','" . $vars['mobilehwd']['mobile_network'][$i] . "',
                        '" . $vars['mobilehwd']['mobile_provider'][$i] . "','" . $vars['mobilehwd']['mobile_service_id_ref'][$i] . "','" . $vars['mobilehwd']['mobile_plan'][$i] . "',
                        '" . $vars['mobilehwd']['mobile_data_allowance'][$i] . "','" . $vars['mobilehwd']['mobile_cost'][$i] . "','" . $vars['mobilehwd']['mobile_user_description'][$i] . "',
                        '" . $vars['mobilehwd']['mobile_contract_type'][$i] . "','" . $vars['mobilehwd']['mobile_service_type'][$i] . "','" . $vars['mobilehwd']['mobile_share_data'][$i] . "',
                        '" . $vars['mobilehwd']['mobile_comments'][$i] . "','" . $vars['mobilehwd']['mobile_date_order'][$i] . "','" . $vars['mobilehwd']['mobile_date_activation'][$i] . "','" . $vars['mobilehwd']['mobile_date_cancel'][$i] . "',
                        '" . $vars['mobilehwd']['mobile_order_ref'][$i] . "','" . $vars['mobilehwd']['mobile_activation_ref'][$i] . "','" . $vars['mobilehwd']['mobile_cancel_ref'][$i] . "','" . $_REQUEST['id'] . "', now())";

                $ret = db_query($mobile_open_sql);
            }
        ...
        // first delete all Password hardware
        $passwordhwd_del_sql = "delete from " . TABLE_PREFIX . "customer_passwordhwd where customer_id= '" . $_REQUEST['id'] . "' ";
        db_query($passwordhwd_del_sql);
        
        if($vars['hwdpassword'])
            // insert Password hardware
            for ($i = 0; $i < count($vars['hwdpassword']['device_service']); $i++) {
                $passwordhwd_open_sql = "insert into " . TABLE_PREFIX . "customer_passwordhwd " .
                    " (device_service, other, brand, model, serial_number, ip_address, mac_address, device_url_ip_address, device_username, device_password," .
                    "  service_url_ip_address, service_username, service_password, service1_ssid, service1_password, service2_ssid, service2_password, description, type, customer_id, last_update) " .
                    " VALUES " .
                    " ('" . $vars['hwdpassword']['device_service'][$i] . "','" . $vars['hwdpassword']['other'][$i] . "','" . $vars['hwdpassword']['brand'][$i] . "',
                                                '" . $vars['hwdpassword']['model'][$i] . "','" . $vars['hwdpassword']['serial_number'][$i] . "','" . $vars['hwdpassword']['ip_address'][$i] . "',
                                                '" . $vars['hwdpassword']['mac_address'][$i] . "','" . $vars['hwdpassword']['device_url_ip_address'][$i] . "','" . $vars['hwdpassword']['device_username'][$i] . "',
                                                '" . $vars['hwdpassword']['device_password'][$i] . "','" . $vars['hwdpassword']['service_url_ip_address'][$i] . "','" . $vars['hwdpassword']['service_username'][$i] . "',
                                                '" . $vars['hwdpassword']['service_password'][$i] . "','" . $vars['hwdpassword']['service1_ssid'][$i] . "','" . $vars['hwdpassword']['service1_password'][$i] . "',
                                                '" . $vars['hwdpassword']['service2_ssid'][$i] . "','" . $vars['hwdpassword']['service2_password'][$i] . "','" . $vars['hwdpassword']['description'][$i] . "','" . $vars['hwdpassword']['type'][$i] . "',
                                                '" . $_REQUEST['id'] . "', now())";
                $ret = db_query($passwordhwd_open_sql);
            }
