        ...
        if(!$errors)
				{
				  ...
				  if($_REQUEST['do'] == 'Add')
					...
					$sql = "$_sql ".TABLE_PREFIX."supplier SET last_update = NOW() , ".
								 ...
								 "  other_dept5		  = '".db_input($vars['other_dept5'],false)."', ".
								 "  other_contact5	  = '".db_input($vars['other_contact5'],false)."', ".
								 "  other_phone5	  = '".db_input($vars['other_phone5'],false)."', ".
								 "  other_mobile5	  = '".db_input($vars['other_mobile5'],false)."', ".
								 "  other_email5	  = '".db_input($vars['other_email5'],false)."', ".
								 "  other_dept6		  = '".db_input($vars['other_dept6'],false)."', ".
								 "  other_contact6	  = '".db_input($vars['other_contact6'],false)."', ".
								 "  other_phone6	  = '".db_input($vars['other_phone6'],false)."', ".
								 "  other_mobile6	  = '".db_input($vars['other_mobile6'],false)."', ".
								 "  other_email6	  = '".db_input($vars['other_email6'],false)."', ".
								 "  other_dept7		  = '".db_input($vars['other_dept7'],false)."', ".
								 "  other_contact7	  = '".db_input($vars['other_contact7'],false)."', ".
								 "  other_phone7	  = '".db_input($vars['other_phone7'],false)."', ".
								 "  other_mobile7	  = '".db_input($vars['other_mobile7'],false)."', ".
								 "  other_email7	  = '".db_input($vars['other_email7'],false)."', ".
